...
export default function Stats() {
  ...
  return (
    ...
    >
      ...
      <div
        className="p-[1px] sm:p-[2px] rounded-[40px] w-[90%] max-w-[1110px] relative z-10 mt-10"
        style={{
          background:
      ...
      >
        {/* Inner white box */}
        <div className="bg-white rounded-[38px] w-full h-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 sm:gap-8 text-center px-2 sm:px-8 py-6 sm:py-10">
          {stats.map((s, i) => (
            <motion.div
              key={i}
