...
export default function Navbar() {
  ...
  const navLinks: { href: string; label: string }[] = [
    ...
    { href: "/privacy", label: "Privacy Policy" }, // 👈 NEW LINK ADDED
  ];
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="hidden sm:flex gap-6 items-center text-sm font-medium pointer-events-auto">
          <a href="tel:+916958998112" className="text-black hover:underline px-1 rounded">
            +91 90890 80505
          </a>
          <a href="mailto:sales@gakgroup.in" className="text-black hover:underline">
            sales@gakgroup.in
          </a>
        </div>
...
<div className="mt-6 flex flex-col gap-1 text-sm text-gray-800 pointer-events-auto">
