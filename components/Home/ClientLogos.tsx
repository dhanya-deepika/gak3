...
export default function BrandsSection() {
  ...
  const scrollByLogos = (dir: "left" | "right") => {
    ...
    if (screenWidth < 640) visible = 1; // mobile → 1 logo
  ...
  return (
    <section className="relative py-6 bg-white overflow-visible">
      <div className="mx-auto w-full flex justify-center px-4 md:px-6">
        <h2
          className="text-center font-normal mb-6 text-black max-w-[90%] sm:max-w-[806px]"
          style={{
            fontFamily: "Sora",
            fontSize: "24px",
            lineHeight: "100%",
